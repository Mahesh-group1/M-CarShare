...
Home:
By clicking on the Home button, it will navigate the user to the home page, where it is the brief overview of the collection of the car M-CarShare has.
Rent:
...
•	Add a car
•	Can view all available cars
•	Can see all the booking on the website
